...
function App() {
  ...
  return (
    <div className="app bg-[#B3BCBB] outline outline-3 outline-black shadow-lg px-10 py-10">
      <div className="outline outline-2 rounded-lg shadow-lg bg-white w-full py-5 flex flex-col justify-center items-center">
